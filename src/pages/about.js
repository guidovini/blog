...
const AboutPage = () => {
  return (
    <Layout>
      ...
      <h2>My Goal</h2>
      <p>
        My goal is to combine these technical knowledge areas into a specialized
        profile which can develop innovative products and solutions using
        multiple points of view among various tech fields.
      </p>
      <p>
        I am actively looking forward to expanding my knowledge, improve my
        skills and obtain relevant experience in the IT industry in order to
        help develop world-changing solutions.
      </p>
      ...
      <p style={{ textAlign: "center" }}>
        ...
        pc building,
        <span role="img" aria-label="online-gamming">
          {" "}
          🎮{" "}
        </span>
        ,
        <span role="img" aria-label="watching movies">
          {" "}
          🍿{" "}
        </span>
        ,
        <span role="img" aria-label="listening to music">
          {" "}
          🎧{" "}
        </span>
        , and
        <span role="img" aria-label="reading books">
          {" "}
          📖
        </span>
        .
